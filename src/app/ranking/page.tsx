            ...
            <div className="space-y-2 max-h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent">
              {filteredData.map((item) => (
                <button
                  ...
                  className={`w-full bg-white/80 backdrop-blur-sm rounded-xl p-4 text-left transition-all border border-gray-100 hover:border-green-200 hover:shadow-md group ${
                    rankedItems.length >= 10 ? 'opacity-50 cursor-not-allowed' : 'hover:scale-[1.01] cursor-pointer'
                  }`}
                >
                ...
                <div className="space-y-2">
                  {rankedItems.map((item, index) => (
                    <div
                      ...
                      className={`group relative flex items-start gap-3 p-3 rounded-xl border-2 transition-all cursor-move ${
                        index === 0
                    ...
                    >
                      ...
                      <div className="flex-shrink-0">
                        <div className={`w-7 h-7 rounded-full flex items-center justify-center text-sm font-normal ${
                          index === 0
              ...
              {rankedItems.length > 0 && (
                <div className="mt-4 space-y-2">
                  <button 
                    onClick={saveRanking}
                    disabled={saving}
                    className={`w-full py-3 rounded-xl font-light transition-all flex items-center justify-center gap-2 ${
                      rankedItems.length === 10
